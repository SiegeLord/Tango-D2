var g_moduleList = [
  ...
  "tango.core.ThreadPool", "tango.core.Traits", "tango.core.Tuple",
  "tango.core.Vararg", "tango.core.Variant", "tango.core.Version",
  "tango.core.sync.Atomic", "tango.core.sync.Barrier",
  ...
  "tango.net.http.HttpTokens", "tango.net.http.HttpTriplet",
  "tango.net.http.model.HttpParamsView", "tango.net.model.UriView",
  "tango.net.util.MemCache", "tango.net.util.PKI", "tango.net.util.c.OpenSSL",
  "tango.stdc.complex", "tango.stdc.config", "tango.stdc.ctype",
  "tango.stdc.errno", "tango.stdc.fenv", "tango.stdc.inttypes",
  "tango.stdc.limits", "tango.stdc.locale", "tango.stdc.math",
  "tango.stdc.posix.arpa.inet", "tango.stdc.posix.config",
  ...
  "tango.sys.solaris.consts.errno", "tango.sys.solaris.consts.socket",
  "tango.sys.solaris.consts.sysctl", "tango.sys.solaris.consts.unistd",
  "tango.sys.solaris.solaris", "tango.sys.win32.CodePage",
  "tango.sys.win32.IUnknown", "tango.sys.win32.Macros",
  "tango.sys.win32.Process", "tango.sys.win32.SpecialPath",
  "tango.sys.win32.Types", "tango.sys.win32.UserGdi",
  "tango.sys.win32.WsaSock", "tango.sys.win32.consts.errno",
  "tango.sys.win32.consts.fcntl", "tango.sys.win32.consts.socket",
  "tango.sys.win32.consts.sysctl", "tango.sys.win32.consts.unistd",
  "tango.text.Arguments", "tango.text.Ascii", "tango.text.Regex",
  "tango.text.Search", "tango.text.Text", "tango.text.Unicode",
  "tango.text.UnicodeData", "tango.text.Util", "tango.text.convert.DateTime",
  ...
  "tango.text.convert.Utf", "tango.text.json.Json",
  "tango.text.json.JsonEscape", "tango.text.json.JsonParser",
  "tango.text.locale.Collation", "tango.text.locale.Convert",
