var g_moduleList = [
  ...
  "tango.core.ThreadPool", "tango.core.Tuple", "tango.core.Vararg",
  "tango.core.Variant", "tango.core.Version", "tango.core.sync.Atomic",
  ...
  "tango.core.tools.Cpuid", "tango.core.tools.FrameInfo",
  ...
  "tango.core.util.string", "tango.io.Console", "tango.io.FileScan",
  "tango.io.FileSystem", "tango.io.Stdout", "tango.io.UnicodeFile",
  "tango.io.device.Array", "tango.io.device.BitBucket",
  "tango.io.device.Conduit", "tango.io.device.Device", "tango.io.device.File",
  "tango.io.device.FileMap", "tango.io.device.TempFile",
  "tango.io.device.ThreadPipe", "tango.io.model.IConduit",
  "tango.io.model.IFile", "tango.io.selector.AbstractSelector",
  "tango.io.selector.EpollSelector", "tango.io.selector.PollSelector",
  "tango.io.selector.SelectSelector", "tango.io.selector.Selector",
  "tango.io.selector.SelectorException", "tango.io.selector.model.ISelector",
  ...
  "tango.math.Probability", "tango.math.random.ExpSource",
  ...
  "tango.net.device.Socket", "tango.net.ftp.Telnet",
  "tango.net.http.ChunkStream", "tango.net.http.HttpClient",
  "tango.net.http.HttpCookies", "tango.net.http.HttpGet",
  "tango.net.http.HttpHeaders", "tango.net.http.HttpParams",
  "tango.net.http.HttpPost", "tango.net.http.HttpStack",
  ...
  "tango.sys.Common", "tango.sys.Environment", "tango.sys.Pipe",
  "tango.sys.Process", "tango.sys.SharedLib", "tango.sys.consts.errno",
  "tango.sys.consts.fcntl", "tango.sys.consts.socket",
  "tango.sys.consts.sysctl", "tango.sys.consts.unistd",
  "tango.sys.darwin.consts.errno", "tango.sys.darwin.consts.fcntl",
  "tango.sys.darwin.consts.machine", "tango.sys.darwin.consts.socket",
  "tango.sys.darwin.consts.sysctl", "tango.sys.darwin.consts.unistd",
  "tango.sys.darwin.darwin", "tango.sys.freebsd.consts.errno",
  "tango.sys.freebsd.consts.fcntl", "tango.sys.freebsd.consts.socket",
  "tango.sys.freebsd.consts.sysctl", "tango.sys.freebsd.consts.unistd",
  "tango.sys.freebsd.freebsd", "tango.sys.linux.consts.errno",
  "tango.sys.linux.consts.fcntl", "tango.sys.linux.consts.socket",
  "tango.sys.linux.consts.sysctl", "tango.sys.linux.consts.unistd",
  "tango.sys.linux.epoll", "tango.sys.linux.inotify", "tango.sys.linux.linux",
  "tango.sys.linux.tipc", "tango.sys.solaris.consts.errno",
  ...
  "tango.text.Search", "tango.text.Text", "tango.text.Unicode",
  "tango.text.UnicodeData", "tango.text.convert.DateTime",
  "tango.text.convert.Float", "tango.text.convert.Format",
  "tango.text.convert.Integer", "tango.text.convert.Layout",
  "tango.text.convert.TimeStamp", "tango.text.convert.UnicodeBom",
  "tango.text.json.Json", "tango.text.json.JsonEscape",
  "tango.text.json.JsonParser", "tango.text.locale.Convert",
  "tango.text.locale.Core", "tango.text.locale.Data",
  "tango.text.locale.Locale", "tango.text.locale.Parse",
  "tango.text.locale.Posix", "tango.text.locale.Win32",
  "tango.text.xml.DocEntity", "tango.text.xml.DocPrinter",
  "tango.text.xml.DocTester", "tango.text.xml.Document",
  "tango.text.xml.PullParser", "tango.text.xml.SaxParser", "tango.time.Clock",
  "tango.time.ISO8601", "tango.time.StopWatch", "tango.time.Time",
  "tango.time.WallClock", "tango.time.chrono.Calendar",
  "tango.time.chrono.Gregorian", "tango.time.chrono.GregorianBased",
  "tango.time.chrono.Hebrew", "tango.time.chrono.Hijri",
  "tango.time.chrono.Japanese", "tango.time.chrono.Korean",
  "tango.time.chrono.Taiwan", "tango.time.chrono.ThaiBuddhist",
  "tango.util.Convert", "tango.util.MinMax", "tango.util.cipher.AES",
  "tango.util.cipher.Blowfish", "tango.util.cipher.ChaCha",
  "tango.util.cipher.Cipher", "tango.util.cipher.RC4", "tango.util.cipher.RC6",
  "tango.util.cipher.Salsa20", "tango.util.cipher.TEA",
  "tango.util.cipher.XTEA", "tango.util.compress.c.bzlib",
  "tango.util.compress.c.zlib", "tango.util.container.CircularList",
  "tango.util.container.Clink", "tango.util.container.Container",
  "tango.util.container.HashMap", "tango.util.container.HashSet",
  "tango.util.container.LinkedList", "tango.util.container.RedBlack",
  "tango.util.container.Slink", "tango.util.container.SortedMap",
  "tango.util.container.model.IContainer", "tango.util.container.more.BitSet",
  "tango.util.container.more.CacheMap", "tango.util.container.more.HashFile",
  "tango.util.container.more.Heap", "tango.util.container.more.Stack",
  "tango.util.container.more.StackMap", "tango.util.container.more.Vector",
  "tango.util.digest.Crc32", "tango.util.digest.Digest",
  "tango.util.digest.Md2", "tango.util.digest.Md4", "tango.util.digest.Md5",
  "tango.util.digest.MerkleDamgard", "tango.util.digest.Ripemd128",
  "tango.util.digest.Ripemd160", "tango.util.digest.Ripemd256",
  "tango.util.digest.Ripemd320", "tango.util.digest.Sha0",
  "tango.util.digest.Sha01", "tango.util.digest.Sha1",
  "tango.util.digest.Sha256", "tango.util.digest.Sha512",
  "tango.util.digest.Tiger", "tango.util.digest.Whirlpool",
  "tango.util.encode.Base16", "tango.util.encode.Base32",
  "tango.util.encode.Base64", "tango.util.log.AppendConsole",
  "tango.util.log.AppendFile", "tango.util.log.AppendFiles",
  "tango.util.log.AppendMail", "tango.util.log.AppendSocket",
  "tango.util.log.AppendSyslog", "tango.util.log.Config",
  ...
  "tango.util.log.model.ILogger", "tango.util.uuid.NamespaceGenV3",
  "tango.util.uuid.NamespaceGenV5", "tango.util.uuid.RandomGen",
