 ...
 *      )
 */
real acos(real x)		{ return phobos.c.math.acosl(x); }
 ...
 *       )
 */
real asin(real x)		{ return phobos.c.math.asinl(x); }
 ...
 *       )
 */
real atan(real x)		{ return phobos.c.math.atanl(x); }
 ...
 *      )
 */
real cosh(real x)		{ return phobos.c.math.coshl(x); }
 ...
 *      )
 */
real sinh(real x)		{ return phobos.c.math.sinhl(x); }
 ...
 *      )
 */
real tanh(real x)		{ return phobos.c.math.tanhl(x); }

//real acosh(real x)		{ return phobos.c.math.acoshl(x); }
//real asinh(real x)		{ return phobos.c.math.asinhl(x); }
//real atanh(real x)		{ return phobos.c.math.atanhl(x); }
 ...
 *	)
 */
real exp(real x)		{ return phobos.c.math.expl(x); }
 ...
 *	)
 */
real exp2(real x)		{ return phobos.c.math.exp2l(x); }
...
real expm1(real x)		{ return phobos.c.math.expm1l(x); }
 ...
 *	)
 */
int ilogb(real x)		{ return phobos.c.math.ilogbl(x); }

alias phobos.c.math.FP_ILOGB0   FP_ILOGB0;
alias phobos.c.math.FP_ILOGBNAN FP_ILOGBNAN;
...
real log(real x)		{ return phobos.c.math.logl(x); }
...
real log10(real x)		{ return phobos.c.math.log10l(x); }
...
real log1p(real x)		{ return phobos.c.math.log1pl(x); }
 ...
 *	)
 */
real log2(real x)		{ return phobos.c.math.log2l(x); }
 ...
 *	)
 */
real logb(real x)		{ return phobos.c.math.logbl(x); }
 ...
 *	)
 */
real modf(real x, inout real y)	{ return phobos.c.math.modfl(x,&y); }
...
{
    version (linux)
	return phobos.c.math.scalbnl(x, n);
    else
 ...
 *	)
 */
real cbrt(real x)		{ return phobos.c.math.cbrtl(x); }
 ...
 */
real erf(real x)		{ return phobos.c.math.erfl(x); }
 ...
 */
real erfc(real x)		{ return phobos.c.math.erfcl(x); }
...
real lgamma(real x)
{
    return phobos.c.math.lgammal(x);
...
real tgamma(real x)
{
    return phobos.c.math.tgammal(x);
 ...
 */
real ceil(real x)		{ return phobos.c.math.ceill(x); }

/**************************************
 * Returns the value of x rounded downward to the next integer
 * (toward negative infinity).
 */
real floor(real x)		{ return phobos.c.math.floorl(x); }
 ...
 */
real nearbyint(real x) { return phobos.c.math.nearbyintl(x); }
...
{
    version (linux)
	return phobos.c.math.llrintl(x);
    else
 ...
 * the even integer. 
 */
real round(real x) { return phobos.c.math.roundl(x); }
...
{
    version (linux)
	return phobos.c.math.llroundl(x);
    else
 ...
 */
real trunc(real x) { return phobos.c.math.truncl(x); }
 ...
 *	)
 */
real remainder(real x, real y) { return phobos.c.math.remainderl(x, y); }

real remquo(real x, real y, out int n)	/// ditto
{
    version (linux)
	return phobos.c.math.remquol(x, y, &n);
    else
...
{
    version (linux)
	return phobos.c.math.nextafterl(x, y);
    else
	throw new NotImplemented("nextafter");
}

//real nexttoward(real x, real y) { return phobos.c.math.nexttowardl(x, y); }
