...
module phobos.socket;

private import phobos.string, phobos.stdint, phobos.c.string, phobos.c.stdlib;
...
version(Win32)
{
	private import phobos.c.windows.windows, phobos.c.windows.winsock;
	private alias phobos.c.windows.winsock.timeval _ctimeval;
...
else version(BsdSockets)
{
	...
	private int _lasterr()
	{
		return phobos.c.stdlib.getErrno();
	}
}
else
{
...
class Socket
{
	...
	body
	{
		...
		{
			if(_SOCKET_ERROR == result && phobos.c.stdlib.getErrno() == EINTR)
				return -1;
		}
		else
		{
