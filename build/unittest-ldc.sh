...
# A simple script to build unittests for on posix for ldc
...
EOF
	...
	$DC -g -w -I../user -L=-Llibs -L=-ltango-user-ldc-tst -nodefaultlib -L=-ltango-base-ldc-tst -L=-L$HOME/lib -L=-ldl -L=-lz -L=-lbz2 -d-debug=UnitTest $EXE.d && rm $EXE.d
