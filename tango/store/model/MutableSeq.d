...
module tango.store.model.MutableSeq;
...
/**
 *
 * MutableSeqs are Seqs possessing standard modification methods
 *
 * 
        author: Doug Lea
 * @version 0.93
...
public interface MutableSeqT(T) : MutableCollectionT!(T), SeqT!(T)
{
        /**
        ...
        **/
        public void insert(int index, IteratorT!(T) e);
        ...
        **/
        ...
        public void prepend(IteratorT!(T) e);
         ...
         * @param e the elements to add
        **/
        public void append(IteratorT!(T) e);
}


alias MutableSeqT!(Object) MutableSeq;