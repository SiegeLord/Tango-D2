...
public interface SeqT(T) : CollectionT!(T)
{
        ...
        **/
        ...
        /**
         * Construct a new SeqT that is a clone of self except
         * that it does not contain the elements before index or
         * after index+length. If length is less than or equal to zero,
         * return an empty SeqT.
         * @param index of the element that will be the 0th index in new SeqT
         * @param length the number of elements in the new SeqT
         ...
         * @exception NoSuchElementException if index is not in range 0..size()-1
        **/
        public SeqT subseq(int index, int _length);
...
version (VERBOSE)
{
        ...
        **/
        ...
        public SeqT insertingAt(int index, T element);
        ...
        **/
        ...
        public SeqT replacingAt(int index, T element);
         ...
         * @exception NoSuchElementException if index is not in range 0..size()-1
        **/
        public SeqT removingAt(int index);
} // version
}

alias SeqT!(Object) Seq;