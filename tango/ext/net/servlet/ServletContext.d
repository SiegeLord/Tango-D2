...
module tango.ext.net.servlet.ServletContext;
...
private import  tango.ext.net.servlet.Dictionary;

private import  tango.ext.net.servlet.ServletException;
...
class ServletContext
{
        ...
        ***********************************************************************/
        ...
        body
        {
                ...
                if (! log)
                      log = Logger.getLogger ("tango.ext.net.servlet.ServletContext");
                this.logger = log;
