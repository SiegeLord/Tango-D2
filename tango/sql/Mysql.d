/**
 * File Original: https://github.com/tbolsh/mysql-wrapping-for-D-programming-language-v2/blob/v0.2.3/example/mysql.d
 *
...
char * mysql_odbc_escape_string(MYSQL *mysql,
								...
								uint from_length,
								void *param,
								char * function(void *, char *to, uint *length) extend_buffer
								);
...
struct st_mysql_methods {
  ...
  my_bool function(MYSQL *mysql,
                              ...
                              uint header_length,
                               char *arg,
                              uint arg_length,
                              my_bool skip_check) advanced_command;
  MYSQL_DATA* function(MYSQL *mysql,MYSQL_FIELD *mysql_fields, uint fields) read_rows;
  MYSQL_RES* function(MYSQL *mysql) use_result;
  void function(uint *to, MYSQL_ROW column, uint field_count) fetch_lengths;
