...
FARPROC GetProcAddress(HINST, const(LPCSTR));
DWORD GetVersion();
...
DWORD GetFileSize(const(HANDLE), LPDWORD);
...
WINBOOL GetFileSizeEx(const(HANDLE), PLARGE_INTEGER); 
...
int WideCharToMultiByte(UINT, DWORD, const(LPCWSTR), int, LPSTR, int, LPCSTR, LPBOOL);
