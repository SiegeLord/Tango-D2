module tango.sys.consts.constSupport;
...
/+module tango.sys.consts.ConstModuleName;
...
version(autoconf){
    public import tango.sys.consts.autoconf.ConstModuleName;
} else version (Windows) {
    version (X86_CPU) {
        static if ((void*).sizeof==4)
            public import tango.sys.win32.consts.ConstModuleName;
        else {
    ...
    version (X86_CPU) {
        public import tango.sys.darwin.consts.ConstModuleName;
    ...
    version (X86_CPU) {
        public import tango.sys.linux.consts.ConstModuleName;
    } else{
        mixin undefinedConsts!("linux on non X86 CPU",__FILE__,__LINE__);
    }
} else version (freebsd) {
    version (X86) {
        public import tango.sys.freebsd.consts.ConstModuleName;
    } else {
        mixin undefinedConsts!("freebsd on non X86 ",__FILE__,__LINE__);
    }
} else version (solaris) {
    version (X86) {
        public import tango.sys.solaris.consts.ConstModuleName;
    } else {
