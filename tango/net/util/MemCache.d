...
class MemCache : private Thread
{
        ...
        **********************************************************************/
        ...
        this (in char[][] hosts, uint watchdog = 3)
        {
                super (&run);
                setHosts (hosts);      
        ...
        **********************************************************************/
        ...
        final bool set (in void[] key, in void[] value, int flags=0, int timeout=0)
        {       
        ...
        **********************************************************************/
        ...
        final bool add (in void[] key, in void[] value, int flags=0, int timeout=0)
        {       
        ...
        **********************************************************************/
        ...
        final bool replace (in void[] key, in void[] value, int flags=0, int timeout=0)
        {
        ...
        **********************************************************************/
        ...
        final bool remove (in void[] key, int timeout=0)
        {
        ...
        **********************************************************************/
        ...
        final bool get (in void[] key, Buffer buffer)
        {       
        ...
        **********************************************************************/
        ...
        final bool incr (in void[] key, uint value)
        {
                uint result;
        ...
        **********************************************************************/
        ...
        final bool decr (in void[] key, uint value)
        {
                uint result;
        ...
        **********************************************************************/
        ...
        final bool incr (in void[] key, uint value, ref uint result)
        {
        ...
        **********************************************************************/
        ...
        final bool decr (in void[] key, uint value, ref uint result)
        {
        ...
        **********************************************************************/
        ...
        final void status (void delegate (in char[], in char[][] list) dg)
        {
                foreach (shared Connection server; hosts)
                         server.status (dg);
        }
        ...
        **********************************************************************/
        ...
        final void setHosts (in char[][] hosts)
        {
                shared(Connection)[] conn = new shared(Connection) [hosts.length];     
        ...
        **********************************************************************/
        ...
        private shared(Connection) select (in void[] key)
        {
	...
	**********************************************************************/
	...
	static final uint jhash (in void[] x, uint c = 0)
	{
	        uint    a,
	                b;
...
private class Connection
{
        ...
        **********************************************************************/
        ...
        private synchronized bool put (in char[] cmd, in void[] key, in void[] value, int flags, int timeout)
        {
                if (connected)
                    try {
                        char[16] tmp;
        ...
        **********************************************************************/
        ...
        private synchronized bool get (in void[] key, MemCache.Buffer buffer)
        {       
                if (connected)
                    try {
                        output.clear;
        ...
        **********************************************************************/
        ...
        private synchronized bool remove (in void[] key, int timeout=0)
        {
                if (connected)
                    try {
                        char[16] tmp;
        ...
        **********************************************************************/
        ...
        private synchronized bool bump (in char[] cmd, in void[] key, uint value, 
                                        ref uint result)
        {
                if (connected)
                    try {
        ...
        **********************************************************************/
        ...
        private synchronized void status (void delegate (in char[], in char[][] list) dg)
        {
                if (connected)
                    try {
                        const(char)[][] list;
