...
unittest
{
    ...
    with(uri)
    {
        ...
        parse("psyc://supraverse.net/~marenz?what#_presence");
        
        assert(scheme == "psyc");
        assert(host == "supraverse.net");
        assert(port == InvalidPort);
