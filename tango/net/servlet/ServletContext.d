...
module tango.net.servlet.ServletContext;
...
private import  tango.net.servlet.Dictionary;

private import  tango.net.servlet.ServletException;
...
class ServletContext
{
        ...
        ***********************************************************************/
        ...
        body
        {
                ...
                if (! log)
                      log = Logger.getLogger ("tango.net.servlet.ServletContext");
                this.logger = log;
