...
__gshared immutable real [] j1modulusn = [ 0x1.059262020bf7520ap-6, 0x1.012ffc4d1f5cdbc8p-3,
...
__gshared immutable real [] j1modulusd = [ 0x1.47d4e6ad98d8246ep-6, 0x1.42562f48058ff904p-3,
...
__gshared immutable real [] j1phasen = [ 0x1.ca9f612d83aaa818p-20, 0x1.2e82fcfb7d0fee9ep-12,
   0x1.e28858c1e947506p-7, 0x1.12b8f96e5173d20ep-2, 0x1.965e6a013154c0ap+0,
   0x1.0156a25eaa0dd78p+1
];

__gshared immutable real [] j1phased = [ 0x1.31bf961e57c71ae4p-18, 0x1.9464d8f2abf750a6p-11,
...
__gshared immutable real j0d[] = [ 0x1.0096dec5f6560158p+73, 0x1.11705db14995fb9cp+66,
   ...
   1.0
    ...
    xx = x * x;
    if ( xx < 81.0L ) {
        __gshared immutable real [] JZ = [5.783185962946784521176L,
   ...
   -0x1.f2d714ab48d1bd7ep+5, 1.0
    ...
    if ( xx < 81.0L ) {
        if ( xx < 20.25L ) {
            ...
            __gshared immutable real [] Y0Z = [3.957678419314857868376e0L, 7.086051060301772697624e0L,
 ...
 */
    ...
    xx = x * x;
    if ( xx < 81.0L ) {
        __gshared immutable real [] JZ = [1.46819706421238932572e1L,
...
__gshared immutable real [] y1n = [ -0x1.32cab2601090742p+54, 0x1.432ceb7a8eaeff16p+52,
...
__gshared immutable real [] y1d = [ 0x1.8733bcfd7236e604p+56, 0x1.5af412c672fd18d4p+50,
...
double cylBessel_i0(double x)
{
    ...
    __gshared immutable double [] A = [    0x1.5a84e9035a22ap-1,  -0x1.37febc057cd8dp-2,
    ...
    __gshared immutable double [] B = [      0x1.9be62aca809cbp-1,   0x1.b998ca2e59049p-9,
...
{     
    __gshared immutable double [] A = [       0x1.02a63724a7ffap-2,  -0x1.694d10469192ep-3,
    ...
    __gshared immutable double [] B = [       0x1.8ea18b55b1514p-1,  -0x1.3fda053fcdb4cp-7,
...
__gshared real[4][] j0_test_points = [
...
__gshared real[4][] y0_test_points = [
...
__gshared real[4][] j1_test_points = [
...
__gshared real[4][] y1_test_points = [
