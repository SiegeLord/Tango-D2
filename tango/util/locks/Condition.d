...
version (Posix)
{
    ...
    class Condition
    {
         ...
         * of time has passed. If $D_PARAM(timeout) == $D_CODE(Interval.infinity)
         * there is no timeout.
         *
...
else version (Windows)
{
    ...
    private class Event
    {
         ...
         * $D_CODE(Interval.infinity) then this method behaves like the one
         * above.
         *
