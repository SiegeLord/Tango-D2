...
\***********************************************************************/
module tango.os.windows.iprtrmib;

import tango.os.windows.ipifcons;
...
struct MIB_IPADDRTABLE {
	...
	new(size_t len) {
		/+void* ptr = new void[DWORD.sizeof + len * MIB_IPADDRROW.sizeof];

		(cast(MIB_IPADDRTABLE*) ptr).dwNumEntries = len;
		return ptr;+/
